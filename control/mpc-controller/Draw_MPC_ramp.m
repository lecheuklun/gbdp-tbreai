...
function Draw_MPC_ramp (t,xx,xx1,u_cl,x_ref,N,rob_diam, conesx,conesy,cones_diam,cone_horizon)
...
for k = 1:size(xx,2)
    ...
    title('Ramp Input Analysis of MPC Controller', 'interpreter', 'latex' );
    axis([0 25 0 25])
    box on;
    grid on 
    drawnow
